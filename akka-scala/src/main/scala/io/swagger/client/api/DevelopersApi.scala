 ...
 * Contact: sheikhazrin@outlook.my
 *
...
object DevelopersApi {
  ...
  def searchInventory(searchString: Option[String] = None, skip: Option[Int] = None, limit: Option[Int] = None): ApiRequest[Seq[InventoryItem]] =
    ApiRequest[Seq[InventoryItem]](ApiMethods.GET, "https://virtserver.swaggerhub.com/digitalskills/start/1.0.0", "/inventory", "application/json")
